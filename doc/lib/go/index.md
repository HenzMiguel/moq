...
[![Go Reference](https://pkg.go.dev/badge/moq.dev/moq.svg)](https://pkg.go.dev/github.com/moq-dev/moq-go)
...
- API reference: [pkg.go.dev/moq.dev/moq](https://pkg.go.dev/github.com/moq-dev/moq-go)
