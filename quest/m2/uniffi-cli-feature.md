...
and a before/after size of `libmoq_ffi.a`, then `just test smoke` for the
generated bindings.

## Related

- [Release size](/quest/m2/release-size.md) - the other half of the shipped-size hygiene, measured with the same table
