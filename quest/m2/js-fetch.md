...
Run the supported-draft matrix and `just test smoke` through CI.
...
- [Dynamic track identity](/quest/m2/2991-net-coalesce-dynamic-tracks-and-preserve-sequences-across.md) - settles shared producer identity before adding on-demand group requests
